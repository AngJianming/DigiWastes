...
//             <div>
//             <button
//                 className="absolute p-2 rounded-md top-0 right-0 hover:text-[#ff5757]"
//                 onClick={() => {
//                 setispopup(false);
//                 }}
//             >
...
//                 <p>
//                 E-waste education empowers you to make eco-friendly choices." –
//                 Knowledge about e-waste empowers individuals to make
