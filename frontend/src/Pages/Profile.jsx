          ...
          <div className="flex flex-col gap-5 ">
            <div className="flex flex-col gap-5 mb-5 ">
              <div className="flex gap-5">
                <h2 className="text-xl text-[#F9F6EE] font-poppins font-semibold">
                  Profile{" "}
                </h2>
                {User?.role == "admin" ? (
                  <h2 className="text-xl font-poppins font-medium text-[#F9F6EE]">
                    Admin
                  </h2>
                ) : (
                  <h2 className="text-xl text-[#F9F6EE] font-poppins font-medium">
                    User
                  </h2>
                )}
              </div>
